							...
							<div class="card-main">
								...
								<div class="card-inner">
										...
										<div class="form-group form-group-label">
											<div class="row">
												<div class="col-md-10 col-md-push-1">
													<label class="floating-label" for="passwd">密码（8位数以上）</label>
									...
									{/if}
									<div class="clearfix">
										<p class="margin-no-top pull-left"><a class="btn waves-attach yw-font" href="/auth/login">已经注册？点我登录</a></p>
										<p class="margin-no-top pull-right"> <a class="btn waves-attach yw-font" href="/">返回官网首页</a>
										</p>
									</div>
								</div>
							</div>
