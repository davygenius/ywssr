											...
											<div data-toggle="tile" data-target="#heading{$node_order->$prefix}">
												...
												<div class="tile-inner">
													<div class="text-overflow">
														<font color="#383838">{if $config["enable_flag"]=='true'}<img src="/images/prefix/{$node_flag_file[$prefix]}.png" onerror="javascript:this.src='/images/prefix/unknown.png';" height="22" width="40" />{/if} {$prefix}</font> | {if $user->class!=0}<font color="#ff9000"><i class="icon icon-lg">flight_takeoff</i></font> <strong>{else}{/if}<b><font color="#828282">在线用户：{$node_alive[$prefix]}</font></b></strong> | <font color="#ff9000"><i class="icon icon-lg">cloud</i></font>  <font color="#828282">负载:{$node_latestload[$prefix]}%</font> 
													</div>
												</div>
											</div>
													...
													<div class="collapsible-region collapse" id="heading{$node_order->$prefix}">
														<div class="tile-sub">
															...
															<div class="card">
																<div class="card-main">
																	<div class="card-inner">
																		<p class="card-heading" align="center"><b> <i class="icon icon-lg">visibility_off</i> {$user->user_name}，您无查看正式用户节点权限，如需购买请<a href="/user/shop">点击这里</a>。</b></p>
																	</div></div></div>
																	{else}
																	{$relay_rule = null}
